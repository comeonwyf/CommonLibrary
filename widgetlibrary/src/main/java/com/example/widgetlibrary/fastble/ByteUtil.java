...
public class ByteUtil {
    ...
    public static void main(String[] args) {
        ...
        byte[] ffffffa6s = long2bytes(-90, 4);

        //byte[] bytes = long2bytes(-90, 4);

        int aaa = (int) bytes2long(ffffffa6s, 0, ffffffa6s.length);
        
        
        System.out.println(bytes2HexStr(ffffffa6s));
        System.out.println(aaa);
        //System.out.println(decimal2fitHex(l));
    }
