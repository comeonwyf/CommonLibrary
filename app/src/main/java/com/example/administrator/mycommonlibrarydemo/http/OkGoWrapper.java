...
import com.example.administrator.mycommonlibrarydemo.http.interf.RequestLogger;
import com.example.administrator.mycommonlibrarydemo.http.util.Bean01Convert;
import com.example.administrator.mycommonlibrarydemo.http.util.Convert2;
import com.example.administrator.mycommonlibrarydemo.http.util.MyConverter;
...
public class OkGoWrapper {
     ...
     * 检查是否已经初始化OkGo
     *
     * @throws IllegalStateException 没有初始化时抛出此异常，需先调用 {@link #initOkGo(Application)}
     */
    private void checkOkGo() {
        try {
            ...
            throw new IllegalStateException(
                "OkGo未初始化，必须先调用OkGoWrapper.initOkGo()");
        }
    }
     ...
     */
    public static OkGoWrapper initOkGo(Application app) {
