...
/**
 * Created by wuyufeng    on  2018/4/19 0019.
 * interface by
 */
...
public class RoundRectImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public RoundRectImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRadius = (int) ta.getDimension(R.styleable.RoundRectImageView_radius,
            getResources().getDimensionPixelOffset(R.dimen.normal_10dp));
        ta.recycle();
        paint = new Paint();
    }
