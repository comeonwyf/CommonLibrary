...
import com.example.serialportlibrary.message.LogManager;
import com.example.serialportlibrary.message.ReceiveCallback;
import com.example.serialportlibrary.message.SendMessage;
import com.example.serialportlibrary.util.ByteUtil;
        ...
        return Observable.create(new ObservableOnSubscribe<Object>() {
            ...
            public void subscribe(ObservableEmitter<Object> emitter) throws Exception {
                try {
                    ...
                    Log.e(TAG, "发送: "+ByteUtil.bytes2HexStr(datas)+ " 失败:"+e);
